            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <div v-for="(episode, index) in this.form.episodes" v-bind:key="index">
                        ...
                        <input :id="'episode-title-' + index" class="rounded shadow appearance-none w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="form.episodes[index].title" />
                        ...
                        <input :id="'episode-description-' + index" class="rounded shadow appearance-none w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="form.episodes[index].description" />
                        ...
                        <input :id="'episode-video_url-' + index" class="rounded shadow appearance-none w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" v-model="form.episodes[index].video_url" />
